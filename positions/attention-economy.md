...
HeartBank will not adopt an advertising-funded revenue model, and will not adopt an engagement-maximizing ranking objective for any feed it operates. The commitment is permanent, and it belongs in the same class as the institution's three other structural self-bindings: that HeartBank will never seek a banking charter, that it will never patent the mechanisms it invents, and that it will never sell, licence, rent, or disclose per-person records — not in aggregate and not de-identified. **The fourth belongs beside the first for a reason worth stating: an institution that refuses advertising has narrowed the field by one, and the model it is most often assumed to have adopted instead is the sale of the record.** A refusal of advertising that leaves the data question unanswered is half a commitment. Each is a door the institution closes deliberately, in public, so that no future pressure can quietly reopen it.
...
**And the second refusal, stated in the same list because a reader who has been told only about advertising is entitled to assume the worst about everything else.** HeartBank will not sell, licence, rent, share for consideration, or disclose per-person records — not in aggregate, not de-identified, not as a research partnership, and not under acquisition or rescue financing. It will not compute or expose a per-person rate, score, or ranking derived from gratitude, and it will not operate a directory of people.

What it intends to sell instead is summarised here so that this position can be read on its own, in the same way §7 summarises rotational discovery. A third party who needs to know something about a person pays **the person** for the right to ask, and pays **the institution** for the fact that the answer can be trusted: the subject sells the release, the institution sells the vouching, and neither can sell the other's good. What moves is a single bit scoped to one question and one asker — no record changes hands and no copy is made. The full statement is *The Person Is Not the Product* (heartbank.net/positions/the-person-is-not-the-product), and the mechanism is published to the commons separately.

**This falls inside the boundary above rather than carving an exception out of it, and the distinction is the whole of it.** The line this position draws is between *being paid by a third party for access to a person* and *being paid by the person receiving the service*. An answer a person has chosen to make available, priced identically for every subject — one posted price per buyer market, never a price per person — and paid mostly to that person, is **the person granting access and being paid for it** — not the institution selling access to them. If that distinction ever stops being legible in practice, it is this position that governs and the market that yields.
...
**The institution's stake, disclosed because the argument is not disinterested.** HeartBank is not a neutral observer of the attention economy; it operates a competing surface, and every claim above is made by the party that benefits from the claim being believed. The argument that ranked discovery is capturable is convenient for an institution that has chosen not to build one, and the reader should discount accordingly. What is offered against that is not sincerity but sequence: the exclusions in §6 were published while the institution had nothing to lose by them, and §8 states the costs and the unresolved half of its own precedent rather than omitting them.

**What would reopen the commitment: nothing on this list.** Falling revenue would not. Competitive pressure would not. An acquirer's preference would not — and the institution's governance is to be arranged — steward ownership beneath a purpose trust — so that no acquirer acquires this decision. A commitment that could be revisited under financial pressure is not a commitment; it is a current preference with better wording, and the whole value of stating this one publicly is to remove the option from the institution's own future management.
